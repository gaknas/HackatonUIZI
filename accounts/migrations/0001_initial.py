    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[('Доктор', 1), (2, 'Менеджер кадров'), (3, 'Руководитель')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sys_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sys_user', to='accounts.employee')),
            ],
            options={
